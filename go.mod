...
replace (
	github.com/kcp-dev/kcp => github.com/kcp-dev/kcp v0.8.1-0.20220928211044-916d7371d0eb // till the next release pointing it to main. Need base options for plugins.
